...
| **Add a volunteer to database**                  | `volunteer create vn/VOLUNTEER_NAME hp/PHONE_NUMBER e/EMAIL` <br> e.g., `volunteer create vn/Cyrus hp/12345678 e/robot123@gmail.com` <br> Abbreviations for `volunteer create` are `v create` and `vc`.                                                                                                                                                                                                                   |
