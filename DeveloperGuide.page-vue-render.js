...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User lists all volunteering events (UCE02).")])]),_v(" "),_c('li',[_c('p',[_v("User requests to read an individual event.")])]),_v(" "),_c('li',[_c('p',[_v("iVolunteer shows a detailed description about that particular event.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to list all events")]),_v(" "),_c('li',[_v("iVolunteer shows a list of events")]),_v(" "),_c('li',[_v("User requests to delete a specific event in the list")]),_v(" "),_c('li',[_v("iVolunteer deletes the event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("1b. Invalid command word.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. iVolunteer requests for the correct command.")]),_v(" "),_c('li',[_v("1b2. User enters correct command "),_c('br'),_v("\nSteps 1b1-1b2 are repeated until the data entered is correct "),_c('br'),_v("\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. Invalid event id")]),_v(" "),_c('ul',[_c('li',[_v("3a1. iVolunteer requests for the correct command with valid event id")]),_v(" "),_c('li',[_v("3a2. User enters correct command "),_c('br'),_v("\nSteps 3a1-3a2 are repeated until the data entered is correct "),_c('br'),_v("\nUse case resumes at step 4.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Tue, 17 Oct 2023, 23:48:40 GMT+8]")])])])}
}];
